/*! For license information please see 8.96177e83.chunk.js.LICENSE */
  ...
  [8],
  {
      ...
      !(function(t) {
        ...
        var S = {
          on: function(t, e, i) {
            ...
            else for (var o = 0, s = (t = p(t)).length; o < s; o++) this._on(t[o], e, i);
            return this;
          },
          off: function(t, e, i) {
            if (t)
              if ('object' === typeof t) for (var n in t) this._off(n, t[n], e);
              else for (var o = 0, s = (t = p(t)).length; o < s; o++) this._off(t[o], e, i);
        ...
        (z.prototype = {
          ...
          (B.prototype = {
            ...
            contains: function(t) {
              var e, i;
              return (
                (t = 'number' === typeof t[0] || t instanceof z ? Z(t) : j(t)) instanceof B
                  ? ((e = t.min), (i = t.max))
                  : (e = i = t),
          ...
          (I.prototype = {
            ...
            contains: function(t) {
              t = 'number' === typeof t[0] || t instanceof D || 'lat' in t ? R(t) : N(t);
              var e,
                i,
                n = this._southWest,
                o = this._northEast;
              return (
                t instanceof I ? ((e = t.getSouthWest()), (i = t.getNorthEast())) : (e = i = t),
        ...
        var Y = document.documentElement.style,
          ...
          tt = Tt('webkit'),
          et = Tt('android'),
          it = Tt('android 2') || Tt('android 3'),
          nt = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
          ot = et && Tt('Google') && nt < 537 && !('AudioNode' in window),
          st = !!window.opera,
          rt = Tt('chrome'),
          at = Tt('gecko') && !tt && !st && !X,
          ht = !rt && Tt('safari'),
          ...
          pt = X && 'transition' in Y,
          dt = 'WebKitCSSMatrix' in window && 'm11' in new window.WebKitCSSMatrix() && !it,
          _t = 'MozPerspective' in Y,
          mt = !window.L_DISABLE_3D && (pt || dt || _t) && !ut && !lt,
          ft = 'undefined' !== typeof orientation || Tt('mobile'),
          gt = ft && tt,
          vt = ft && dt,
          yt = !window.PointerEvent && window.MSPointerEvent,
          bt = !tt && !(!window.PointerEvent && !yt),
          Lt =
            !window.L_NO_TOUCH &&
            ...
            'touchstart' === e
              ? (function(t, e, i) {
                  ...
                  (t['_leaflet_touchstart' + i] = n),
                    ...
                    It ||
                      (document.documentElement.addEventListener(kt, Rt, !0),
                      document.documentElement.addEventListener(zt, Ut, !0),
                      document.documentElement.addEventListener(At, Gt, !0),
              ...
              : 'touchend' === e &&
                (function(t, e, i) {
                  ...
                  (t['_leaflet_touchend' + i] = n), t.addEventListener(At, n, !1), t.addEventListener(Zt, n, !1);
                })(t, i, n),
            this
          );
        }
        ...
        function Gt(t) {
          delete jt[t.pointerId], Nt--;
        }
        function Ht(t, e) {
          for (var i in ((t.touches = []), jt)) t.touches.push(jt[i]);
          (t.changedTouches = [t]), e(t);
        }
        var Wt = yt ? 'MSPointerDown' : bt ? 'pointerdown' : 'touchstart',
          Ft = yt ? 'MSPointerUp' : bt ? 'pointerup' : 'touchend',
          Vt = '_leaflet_';
        function qt(t, e, i) {
          var n,
            o,
          ...
          return (
            ...
            t.addEventListener(Ft, h, !!Ct && { passive: !1 }),
        ...
        function Kt(t, e) {
          var i = t[Vt + Wt + e],
            ...
            o = t[Vt + 'dblclick' + e];
          return (
            t.removeEventListener(Wt, i, !!Ct && { passive: !1 }),
            t.removeEventListener(Ft, n, !!Ct && { passive: !1 }),
        ...
        function ce(t, e) {
          if (void 0 !== t.classList) for (var i = p(e), n = 0, o = i.length; n < o; n++) t.classList.add(i[n]);
          else if (!ue(t, e)) {
            var s = _e(t);
            de(t, (s ? s + ' ' : '') + e);
          }
        ...
        function pe(t, e) {
          void 0 !== t.classList ? t.classList.remove(e) : de(t, c((' ' + _e(t) + ' ').replace(' ' + e + ' ', ' ')));
        }
        function de(t, e) {
        ...
        if ('onselectstart' in document)
          ...
          (Jt = function() {
            ...
            (Yt = function() {
              be && ((document.documentElement.style[be] = Xt), (Xt = void 0));
            });
        }
        function Le() {
        ...
        function xe() {
          Se(window, 'dragstart', je);
        }
        function we(t) {
          for (; -1 === t.tabIndex; ) t = t.parentNode;
          t.style && (Pe(), (Qt = t), ($t = t.style.outline), (t.style.outline = 'none'), Ee(window, 'keydown', Pe));
        }
        function Pe() {
          Qt && ((Qt.style.outline = $t), (Qt = void 0), ($t = void 0), Se(window, 'keydown', Pe));
        }
        function Ce(t) {
          do {
            t = t.parentNode;
        ...
        function Ee(t, e, i, n) {
          if ('object' === typeof e) for (var o in e) ke(t, o, e[o], i);
          else for (var s = 0, r = (e = p(e)).length; s < r; s++) ke(t, e[s], i, n);
          return this;
        }
        var Te = '_leaflet_events';
        function Se(t, e, i, n) {
          if ('object' === typeof e) for (var o in e) ze(t, o, e[o], i);
          else if (e) for (var s = 0, r = (e = p(e)).length; s < r; s++) ze(t, e[s], i, n);
          else {
            for (var a in t[Te]) ze(t, a, t[Te][a]);
            delete t[Te];
          }
          return this;
        }
          ...
          bt && 0 === e.indexOf('touch')
            ? (function(t, e, i) {
                ...
                'touchstart' === e
                  ...
                  : 'touchend' === e && (t.removeEventListener(At, n, !1), t.removeEventListener(Zt, n, !1));
              })(t, e, o)
            : !Lt || 'dblclick' !== e || !Kt || (bt && rt)
        ...
        function Ze(t) {
          return ke(t, 'mousewheel', Ae), this;
        }
        function Be(t) {
          return Ee(t, 'mousedown touchstart dblclick', Ae), ke(t, 'click', He), this;
        }
        function je(t) {
        ...
        var De = ct && rt ? 2 * window.devicePixelRatio : at ? window.devicePixelRatio : 1;
        function Re(t) {
          return $
            ? t.wheelDeltaY / 2
          ...
          Ke = k.extend({
            ...
            initialize: function(t, e) {
              (e = d(this, e)),
                ...
                this.callInitHooks(),
                (this._zoomAnimated = ee && mt && !xt && this.options.zoomAnimation),
                this._zoomAnimated && (this._createAnimProxy(), Ee(this._proxy, ie, this._catchTransitionEnd, this)),
            ...
            flyTo: function(t, e, i) {
              ...
              var m = p(0);
              function f(t) {
                return (a * (_(m) * (d((e = m + u * t)) / _(e)) - d(m))) / c;
                var e;
              }
              var g = Date.now(),
                v = (p(1) - m) / u,
            ...
            panInside: function(t, e) {
              var i = Z((e = e || {}).paddingTopLeft || e.padding || [0, 0]),
                ...
                l = j([a.min.add(i), a.max.subtract(n)]);
              if (!l.contains(r)) {
                this._enforcingBounds = !0;
                var u = s.subtract(r),
                  c = Z(r.x + u.x, r.y + u.y);
            ...
            remove: function() {
              ...
              this._resizeRequest && (O(this._resizeRequest), (this._resizeRequest = null)),
              this._clearHandlers(),
            ...
            getBoundsZoom: function(t, e, i) {
              ...
              var n = this.getZoom() || 0,
                ...
                l = j(this.project(a, n), this.project(r, n)).getSize(),
                u = mt ? this.options.zoomSnap : 1,
                c = h.x / l.x,
                p = h.y / l.y,
                d = e ? Math.max(c, p) : Math.min(c, p);
              return (
            ...
            _findEventTargets: function(t, e) {
              ...
              return n.length || a || o || !Fe(s, t) || (n = [this]), n;
            },
            ...
            _fireDOMEvent: function(t, e, n) {
              ...
              if (!t._stopped && (n = (n || []).concat(this._findEventTargets(t, e))).length) {
                var s = n[0];
                'contextmenu' === e && s.listens(e, !0) && je(t);
            ...
            _getBoundsOffset: function(t, e, i) {
              var n = j(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i)),
        ...
        var Xe = Je.extend({
            ...
            _initLayout: function() {
              ...
              i &&
                ...
                et || Ee(e, { mouseenter: this.expand, mouseleave: this.collapse }, this));
              var o = (this._layersLink = se('a', t + '-toggle', e));
              (o.href = '#'),
                (o.title = 'Layers'),
                Lt ? (Ee(o, 'click', Ie), Ee(o, 'click', this.expand, this)) : Ee(o, 'focus', this.expand, this),
                i || this.expand(),
          ...
          Qe = Je.extend({
            ...
            _createButton: function(t, e, i, n, o) {
              ...
              return (
                ...
                Ee(s, 'click', Ie),
                Ee(s, 'click', o, this),
                Ee(s, 'click', this._refocusOnMap, this),
                s
              );
            },
        ...
        var ii,
          ni = { Events: S },
          oi = Lt ? 'touchstart mousedown' : 'mousedown',
          ...
          ai = k.extend({
            ...
            enable: function() {
              this._enabled || (Ee(this._dragStartTarget, oi, this._onDown, this), (this._enabled = !0));
            },
            disable: function() {
              this._enabled &&
                (ai._dragging === this && this.finishDrag(),
                Se(this._dragStartTarget, oi, this._onDown, this),
                (this._enabled = !1),
                (this._moved = !1));
            },
            _onDown: function(t) {
              if (
                ...
                !ue(this._element, 'leaflet-zoom-anim') &&
                  ...
                  ((ai._dragging = this), this._preventOutline && we(this._element), Le(), Jt(), !this._moving))
              ) {
                this.fire('down');
                ...
                (this._startPoint = new z(e.clientX, e.clientY)),
                  ...
                  Ee(document, si[t.type], this._onUp, this);
              }
            },
            _onMove: function(t) {
            ...
            finishDrag: function() {
              ...
              ri))
                Se(document, ri[t], this._onMove, this), Se(document, si[t], this._onUp, this);
              xe(),
                Yt(),
                this._moved &&
                  this._moving &&
                  (O(this._animRequest), this.fire('dragend', { distance: this._newPos.distanceTo(this._startPos) })),
                (this._moving = !1),
                (ai._dragging = !1);
            }
          });
            ...
            (n[0] = n[i - 1] = 1),
              (function t(e, i, n, o, s) {
                var r,
                  ...
                  h,
                  l = 0;
                for (a = o + 1; a <= s - 1; a++) (h = _i(e[a], e[o], e[s], !0)) > l && ((r = a), (l = h));
        ...
        function ui(t, e, i, n, o) {
          ...
          for (ii = l; ; ) {
            if (!(h | l)) return [t, e];
            if (h & l) return !1;
            (a = pi((r = ci(t, e, (s = h || l), i, o)), i)), s === h ? ((t = r), (h = a)) : ((e = r), (l = a));
          }
        }
        ...
        function vi(t, e, i) {
          ...
          for (r = 0; r < 4; r++) {
            for (u = p[r], n = [], o = 0, s = (l = t.length) - 1; o < l; s = o++)
              (a = t[o]),
                (h = t[s]),
                a._code & u
                  ? h._code & u || (((c = ci(h, a, u, e, i))._code = pi(c, e)), n.push(c))
                  : (h._code & u && (((c = ci(h, a, u, e, i))._code = pi(c, e)), n.push(c)), n.push(a));
            t = n;
          }
          return t;
        }
        var yi = (Object.freeze || Object)({ clipPolygon: vi }),
          ...
          xi = (Object.freeze || Object)({ LonLat: bi, Mercator: Li, SphericalMercator: H }),
          wi = i({}, G, {
            code: 'EPSG:3395',
            projection: Li,
            transformation: (function() {
          ...
          Pi = i({}, G, { code: 'EPSG:4326', projection: bi, transformation: F(1 / 180, 1, -1 / 180, 0.5) }),
          Ci = i({}, U, {
            projection: bi,
        ...
        (U.Earth = G), (U.EPSG3395 = wi), (U.EPSG3857 = V), (U.EPSG900913 = q), (U.EPSG4326 = Pi), (U.Simple = Ci);
        var Mi = k.extend({
        ...
        var Oi = Mi.extend({
          ...
          Ei = Oi.extend({
            addLayer: function(t) {
              return this.hasLayer(t)
                ? this
                : (t.addEventParent(this), Oi.prototype.addLayer.call(this, t), this.fire('layeradd', { layer: t }));
            },
            removeLayer: function(t) {
              return this.hasLayer(t)
                ? (t in this._layers && (t = this._layers[t]),
                  t.removeEventParent(this),
                  Oi.prototype.removeLayer.call(this, t),
          ...
          Si = Ti.extend({
            ...
            _getIconUrl: function(t) {
              return (
                Si.imagePath || (Si.imagePath = this._detectIconPath()),
                (this.options.imagePath || Si.imagePath) + Ti.prototype._getIconUrl.call(this, t)
              );
            },
          ...
          ki = ei.extend({
            ...
            _adjustPan: function(t) {
              var e = this._marker,
                ...
                r = i.getPixelBounds(),
                a = i.getPixelOrigin(),
                h = j(r.min._subtract(a).add(o), r.max._subtract(a).subtract(o));
              if (!h.contains(s)) {
                var l = Z(
            ...
            _onPreDrag: function(t) {
              this._marker.options.autoPan &&
                (O(this._panRequest), (this._panRequest = M(this._adjustPan.bind(this, t))));
            },
            _onDrag: function(t) {
              var e = this._marker,
                i = e._shadow,
          ...
          zi = Mi.extend({
            ...
            _initInteraction: function() {
              if (
                ...
                (ce(this._icon, 'leaflet-interactive'), this.addInteractiveTarget(this._icon), ki)
              ) {
          ...
          ji = Ai.extend({
            ...
            closestLayerPoint: function(t) {
              for (var e, i, n = 1 / 0, o = null, s = _i, r = 0, a = this._parts.length; r < a; r++)
        ...
        var Ii = ji.extend({
            ...
            _convertLatLngs: function(t) {
              var e = ji.prototype._convertLatLngs.call(this, t),
                i = e.length;
              return i >= 2 && e[0] instanceof D && e[0].equals(e[i - 1]) && e.pop(), e;
            },
            _setLatLngs: function(t) {
              ji.prototype._setLatLngs.call(this, t), mi(this._latlngs) && (this._latlngs = [this._latlngs]);
            },
            _defaultShape: function() {
            ...
            _containsPoint: function(t) {
              ...
              return l || ji.prototype._containsPoint.call(this, t, !0);
            }
          }),
          Ni = Ei.extend({
            initialize: function(t, e) {
        ...
        function Di(t, e) {
          ...
          switch (r.type) {
            case 'Point':
              return Ri(l, t, (i = u(a)), e);
            case 'MultiPoint':
              for (o = 0, s = a.length; o < s; o++) (i = u(a[o])), h.push(Ri(l, t, i, e));
              return new Ei(h);
            case 'LineString':
            case 'MultiLineString':
              return (n = Gi(a, 'LineString' === r.type ? 0 : 1, u)), new ji(n, e);
            case 'Polygon':
            case 'MultiPolygon':
              return (n = Gi(a, 'Polygon' === r.type ? 1 : 2, u)), new Ii(n, e);
            case 'GeometryCollection':
              for (o = 0, s = r.geometries.length; o < s; o++) {
                var c = Di({ geometry: r.geometries[o], type: 'Feature', properties: t.properties }, e);
                c && h.push(c);
              }
              return new Ei(h);
            default:
        ...
        function Gi(t, e, i) {
          for (var n, o = [], s = 0, r = t.length; s < r; s++)
            (n = e ? Gi(t[s], e - 1, i) : (i || Ui)(t[s])), o.push(n);
          return o;
        }
        function Hi(t, e) {
          return (
        ...
        function Wi(t, e, i, n) {
          for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? Wi(t[s], e - 1, i, n) : Hi(t[s], n));
        ...
        var qi = {
          toGeoJSON: function(t) {
            return Fi(this, { type: 'Point', coordinates: Hi(this.getLatLng(), t) });
          }
        };
        function Ki(t, e) {
          return new Ni(t, e);
        ...
        zi.include(qi),
          ...
          Ii.include({
            toGeoJSON: function(t) {
              ...
              return e || (n = [n]), Fi(this, { type: (i ? 'Multi' : '') + 'Polygon', coordinates: n });
            }
          }),
          Oi.include({
            ...
            toGeoJSON: function(t) {
              ...
              return (
                ...
                i ? Fi(this, { geometries: n, type: 'GeometryCollection' }) : { type: 'FeatureCollection', features: n }
              );
            }
          });
        var Ji = Ki,
          ...
          $i = Mi.extend({
            ...
            _prepareOpen: function(t, e, i) {
              if ((e instanceof Mi || ((i = e), (e = t)), e instanceof Ei))
          ...
          tn = $i.extend({
            ...
            onAdd: function(t) {
              $i.prototype.onAdd.call(this, t),
                ...
                this._source &&
                  ...
                  this._source instanceof Ai || this._source.on('preclick', Ae));
            },
            onRemove: function(t) {
              $i.prototype.onRemove.call(this, t),
                ...
                this._source &&
                  ...
                  this._source instanceof Ai || this._source.off('preclick', Ae));
            },
            getEvents: function() {
            ...
            _initLayout: function() {
              ...
              if (
                ...
                (n.href = '#close'), (n.innerHTML = '&#215;'), Ee(n, 'click', this._onCloseButtonClick, this);
              }
            },
            _updateLayout: function() {
              ...
              o && n > o ? ((e.height = o + 'px'), ce(t, 'leaflet-popup-scrolled')) : pe(t, 'leaflet-popup-scrolled'),
        ...
        var en = $i.extend({
          ...
          getEvents: function() {
            var t = $i.prototype.getEvents.call(this);
            return Lt && !this.options.permanent && (t.preclick = this._close), t;
          },
          _close: function() {
          ...
          _setPosition: function(t) {
            var e = this._map,
              ...
              l = this._getAnchor();
            'top' === s
              ? (t = t.add(Z(-r / 2 + h.x, -a + h.y + l.y, !0)))
              : 'bottom' === s
              ? (t = t.subtract(Z(r / 2 - h.x, -h.y, !0)))
              : 'center' === s
              ? (t = t.subtract(Z(r / 2 + h.x, a / 2 - l.y + h.y, !0)))
              : 'right' === s || ('auto' === s && o.x < n.x)
              ? ((s = 'right'), (t = t.add(Z(h.x + l.x, l.y - a / 2 + h.y, !0))))
              : ((s = 'left'), (t = t.subtract(Z(r + l.x - h.x, a / 2 - l.y - h.y, !0)))),
        ...
        var on = Mi.extend({
            ...
            _updateOpacity: function() {
              if (this._map && !Q) {
                ...
                i && !this._noPrune && this._pruneTiles(),
                  e && (O(this._fadeFrame), (this._fadeFrame = M(this._updateOpacity, this)));
              }
            },
            _onOpaqueTile: l,
                    ...
                    for (var c = o.min.y; c <= o.max.y; c++)
                      for (var p = o.min.x; p <= o.max.x; p++) {
                        ...
                        if (((d.z = this._tileZoom), this._isValidTile(d))) {
                          var _ = this._tiles[this._tileCoordsToKey(d)];
                          _ ? (_.current = !0) : r.push(d);
                        }
                      }
                    if (
                      (r.sort(function(t, e) {
            ...
            _tileReady: function(t, e, i) {
              ...
              (i = this._tiles[n]) &&
                ...
                this._map._fadeAnimated
                  ? (me(i.el, 0), O(this._fadeFrame), (this._fadeFrame = M(this._updateOpacity, this)))
          ...
          sn = on.extend({
            ...
            createTile: function(t, e) {
              ...
              return (
                Ee(i, 'load', o(this._tileOnLoad, this, e, i)),
                Ee(i, 'error', o(this._tileOnError, this, e, i)),
                (this.options.crossOrigin || '' === this.options.crossOrigin) &&
        ...
        var an = sn.extend({
          ...
          getTileUrl: function(t) {
            ...
            return (
              a + _(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? '&BBOX=' : '&bbox=') + r
            );
          },
        ...
        (_n.create = dn),
          ...
          (Ni.coordsToLatLng = Ui),
          (Ni.coordsToLatLngs = Gi),
        ...
        var gn = ei.extend({
          ...
          _onMouseDown: function(t) {
            ...
            this._clearDeferredResetState(),
              ...
              Ee(
                document,
                { contextmenu: Ie, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown },
                this
              );
          },
          _onMouseMove: function(t) {
          ...
          _finish: function() {
            this._moved && (re(this._box), pe(this._container, 'leaflet-crosshair')),
              Yt(),
              xe(),
              Se(
                document,
        ...
        var yn = ei.extend({
          ...
          _onDragEnd: function(t) {
            ...
            if ((e.fire('dragend', t), n)) e.fire('moveend');
              ...
              p.x || p.y
                ? ((p = e._limitOffset(p, e.options.maxBounds)),
                  M(function() {
                    e.panBy(p, { duration: c, easeLinearity: r, noMoveStart: !0, animate: !0 });
                  }))
                : e.fire('moveend');
            }
          }
        ...
        var bn = ei.extend({
          ...
          addHooks: function() {
            ...
            t.tabIndex <= 0 && (t.tabIndex = '0'),
              Ee(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
        ...
        Ke.addInitHook('addHandler', 'keyboard', bn),
          Ke.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 });
        var Ln = ei.extend({
          addHooks: function() {
            Ee(this._map._container, 'mousewheel', this._onWheelScroll, this), (this._delta = 0);
          },
          removeHooks: function() {
          ...
          _onWheelScroll: function(t) {
            ...
            clearTimeout(this._timer), (this._timer = setTimeout(o(this._performZoom, this), n)), Ie(t);
          },
        ...
        Ke.addInitHook('addHandler', 'scrollWheelZoom', Ln), Ke.mergeOptions({ tap: !0, tapTolerance: 15 });
        var xn = ei.extend({
          addHooks: function() {
          ...
          _onUp: function(t) {
            if (
              ...
              Se(document, { touchmove: this._onMove, touchend: this._onUp }, this),
        ...
        Lt && !bt && Ke.addInitHook('addHandler', 'tap', xn),
          Ke.mergeOptions({ touchZoom: Lt && !it, bounceAtZoomLimits: !0 });
        var wn = ei.extend({
          addHooks: function() {
          ...
          _onTouchMove: function(t) {
            if (t.touches && 2 === t.touches.length && this._zooming) {
              ...
              (this._animRequest = M(a, this, !0)), je(t);
            }
          },
        ...
        Ke.addInitHook('addHandler', 'touchZoom', wn),
          (Ke.BoxZoom = gn),
          (Ke.DoubleClickZoom = vn),
          (Ke.Drag = yn),
          (Ke.Keyboard = bn),
          (Ke.ScrollWheelZoom = Ln),
          (Ke.Tap = xn),
          (Ke.TouchZoom = wn),
          (Object.freeze = e),
          (t.version = '1.6.0'),
    ...
    1078: function(t, e, i) {
      ...
      var n = i(1082),
        ...
        l = function() {
          return Object(r.useContext)(h);
        },
        u = h.Consumer,
        c = h.Provider,
        p = function(t) {
          var e = function(e, i) {
              return a.a.createElement(u, null, function(o) {
                return a.a.createElement(t, Object(n.a)({}, e, { leaflet: o, ref: i }));
              });
            },
            i = t.displayName || t.name || 'Component';
          e.displayName = 'Leaflet(' + i + ')';
          var o = Object(r.forwardRef)(e);
          return s()(o, t), o;
        };
    },
    1082: function(t, e, i) {
        ...
        l = (function(t) {
          function e(e) {
            ...
            return (
              ...
              Object(r.a)(Object(o.a)(i), '_leafletEvents', void 0),
              Object(r.a)(Object(o.a)(i), 'leafletElement', void 0),
    ...
    1192: function(t, e, i) {
      ...
      e.b = function(t, e, i) {
        null != t && i !== e && (null != e && e.length > 0 && r(t, e), null != i && i.length > 0 && s(t, i));
      };
    },
    1193: function(t, e, i) {
      'use strict';
      ...
      var n = i(1078),
        ...
        u = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(r.a)(i), 'leafletElement', void 0),
              (i.leafletElement = i.createLeafletElement(i.props)),
              i
            );
          }
          Object(o.a)(e, t);
      ...
      var y = i(1119),
          ...
          return (
            ...
            (e.prototype.getOptions = function(t) {
              return null != t.pane
                ...
                ? Object(_.a)({}, t, { pane: t.leaflet.pane })
                : t;
            }),
            e
          );
        ...
        L = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(r.a)(i), 'contextValue', void 0),
              Object(a.a)(Object(r.a)(i), 'leafletElement', void 0),
              (i.leafletElement = i.createLeafletElement(e)),
              i
            );
          }
          Object(o.a)(e, t);
          ...
          return (
            ...
            (i.componentDidUpdate = function(e) {
              if ((t.prototype.componentDidUpdate.call(this, e), this.props.attribution !== e.attribution)) {
                var i = this.props.leaflet.map;
                null != i &&
                  null != i.attributionControl &&
                  (i.attributionControl.removeAttribution(e.attribution),
                  i.attributionControl.addAttribution(this.props.attribution));
              }
            ...
            (i.render = function() {
              ...
              return null == t
                ...
                ? l.a.createElement(h.Fragment, null, t)
                : l.a.createElement(n.b, { value: this.contextValue }, t);
            }),
            v(e, [
              {
                key: 'layerContainer',
      ...
      var x = [
        ...
        w = (function(t) {
          function e(e) {
            var i;
            return (
              null == (i = t.call(this, e) || this).contextValue &&
                (i.contextValue = Object(_.a)({}, e.leaflet, { popupContainer: i.leafletElement })),
              i
            );
          }
          Object(o.a)(e, t);
          ...
          return (
            ...
            (i.getPathOptions = function(t) {
              return (
                (e = t),
                x.reduce(function(t, i) {
                  return 'undefined' !== typeof e[i] && (t[i] = e[i]), t;
                }, {})
              );
              var e;
            }),
            (i.setStyle = function(t) {
              void 0 === t && (t = {}), this.leafletElement.setStyle(t);
            }),
            (i.setStyleIfChanged = function(t, e) {
              var i = this.getPathOptions(e);
              f()(i, this.getPathOptions(t)) || this.setStyle(i);
            }),
            e
          );
        })(L),
        P = (function(t) {
          ...
          return (
            (i.createLeafletElement = function(t) {
              var e = t.center,
                i = t.radius,
                n = Object(d.a)(t, ['center', 'radius']);
              return new s.Circle(e, i, this.getOptions(n));
            }),
            (i.updateLeafletElement = function(t, e) {
              e.center !== t.center && this.leafletElement.setLatLng(e.center),
                e.radius !== t.radius && this.leafletElement.setRadius(e.radius);
            }),
            e
          );
        })(w),
        ...
        M = (function(t) {
          ...
          return (
            (i.createLeafletElement = function(t) {
              var e = new s.CircleMarker(t.center, this.getOptions(t));
              return (this.contextValue = Object(_.a)({}, t.leaflet, { popupContainer: e })), e;
            }),
            (i.updateLeafletElement = function(t, e) {
              e.center !== t.center && this.leafletElement.setLatLng(e.center),
                e.radius !== t.radius && this.leafletElement.setRadius(e.radius);
        ...
        S = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(r.a)(i), 'onClose', function() {
                i.props.onClose && i.props.onClose();
              }),
              Object(a.a)(Object(r.a)(i), 'onOpen', function() {
                i.forceUpdate(), i.props.onOpen && i.props.onOpen();
              }),
              (i.leafletElement = i.createLeafletElement(e)),
              i
            );
          ...
          return (
            ...
            (i.updateLeafletElement = function(t, e) {}),
            (i.componentDidUpdate = function(t) {
              Object(T.b)(this.leafletElement._container, t.className, this.props.className),
                this.updateLeafletElement(t, this.props),
                this.leafletElement.isOpen() && (this.leafletElement.update(), this.onRender());
            }),
            (i.onRender = function() {}),
            (i.render = function() {
              return this.leafletElement._contentNode
                ? Object(E.createPortal)(this.props.children, this.leafletElement._contentNode)
                : null;
            }),
            e
          );
        ...
        k = (function(t) {
          ...
          return (
            (i.createLeafletElement = function(t) {
              var e = new s.FeatureGroup(this.getOptions(t));
              return (this.contextValue = Object(_.a)({}, t.leaflet, { layerContainer: e, popupContainer: e })), e;
            }),
            (i.componentDidMount = function() {
        ...
        A = (function(t) {
          ...
          return (
            (i.createLeafletElement = function(t) {
              return new s.GeoJSON(t.data, this.getOptions(t));
            }),
            (i.updateLeafletElement = function(t, e) {
              'function' === typeof e.style ? this.leafletElement.setStyle(e.style) : this.setStyleIfChanged(t, e);
            }),
            e
          );
        })(w),
        ...
        B = (function(t) {
          ...
          return (
            ...
            (i.getOptions = function(e) {
              var i = t.prototype.getOptions.call(this, e);
              return null == e.leaflet.map
                ? i
                : Object(_.a)({ maxZoom: e.leaflet.map.options.maxZoom, minZoom: e.leaflet.map.options.minZoom }, i);
            }),
            (i.render = function() {
              return null;
            }),
        ...
        j = (function(t) {
          ...
          return (
            (i.createLeafletElement = function(t) {
              var e = new s.ImageOverlay(t.url, t.bounds, this.getOptions(t));
              return (this.contextValue = Object(_.a)({}, t.leaflet, { popupContainer: e })), e;
            }),
            (i.updateLeafletElement = function(t, e) {
        ...
        N = (function(t) {
          ...
          return (
            Object(o.a)(e, t),
            (e.prototype.createLeafletElement = function(t) {
              var e = new s.LayerGroup([], this.getOptions(t));
              return (this.contextValue = Object(_.a)({}, t.leaflet, { layerContainer: e })), e;
            }),
            e
          );
        })(L),
        ...
        R = (function(t) {
          function e() {
            ...
            return (
              ...
              Object(a.a)(Object(r.a)(e), 'contextValue', void 0),
              Object(a.a)(Object(r.a)(e), 'layer', void 0),
              e
            );
          }
          Object(o.a)(e, t);
          ...
          return (
            (i.componentDidUpdate = function(t) {
              var e = t.checked;
              null != this.props.leaflet.map &&
                (!0 !== this.props.checked || (null != e && !1 !== e)
                  ? !0 !== e ||
                    (null != this.props.checked && !1 !== this.props.checked) ||
            ...
            (i.render = function() {
              var t = this.props.children;
              return t ? l.a.createElement(n.b, { value: this.contextValue }, t) : null;
            }),
            e
          );
        })(h.Component),
        U = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(r.a)(i), 'addLayer', function(t) {
                i.layer = t;
                var e = i.props,
                  n = e.addBaseLayer,
                  o = e.checked;
              ...
              (i.contextValue = Object(_.a)({}, e.leaflet, {
                layerContainer: {
                  addLayer: i.addLayer.bind(Object(r.a)(i)),
                  removeLayer: i.removeLayer.bind(Object(r.a)(i))
                }
              })),
              i
            );
        ...
        H = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(r.a)(i), 'controlProps', void 0),
              (i.controlProps = {
                addBaseLayer: i.addBaseLayer.bind(Object(r.a)(i)),
                addOverlay: i.addOverlay.bind(Object(r.a)(i)),
                leaflet: e.leaflet,
                removeLayer: i.removeLayer.bind(Object(r.a)(i)),
                removeLayerControl: i.removeLayerControl.bind(Object(r.a)(i))
              }),
              i
            );
          }
          ...
          return (
            (i.createLeafletElement = function(t) {
              t.children;
              var e = Object(d.a)(t, ['children']);
              return new s.Control.Layers(void 0, void 0, e);
            }),
            (i.updateLeafletElement = function(e, i) {
              t.prototype.updateLeafletElement.call(this, e, i),
                i.collapsed !== e.collapsed &&
                  (!0 === i.collapsed ? this.leafletElement.collapse() : this.leafletElement.expand());
            }),
            (i.componentWillUnmount = function() {
              var e = this;
              setTimeout(function() {
            ...
            (i.addBaseLayer = function(t, e, i) {
              void 0 === i && (i = !1),
                i && null != this.props.leaflet.map && this.props.leaflet.map.addLayer(t),
                this.leafletElement.addBaseLayer(t, e);
            }),
            (i.addOverlay = function(t, e, i) {
              void 0 === i && (i = !1),
                i && null != this.props.leaflet.map && this.props.leaflet.map.addLayer(t),
                this.leafletElement.addOverlay(t, e);
            }),
            (i.removeLayer = function(t) {
              null != this.props.leaflet.map && this.props.leaflet.map.removeLayer(t);
            }),
            (i.removeLayerControl = function(t) {
            ...
            (i.render = function() {
              ...
              return l.a.createElement(h.Fragment, null, e);
            }),
            e
          );
        })(u),
        W = Object(n.d)(H);
      (W.BaseLayer = U), (W.Overlay = G);
      var F = W,
        V = i(1286),
        q = (function(t) {
          function e() {
          ...
          return (
            (i.createLeafletElement = function(t) {
              var e = new s.Marker(t.position, this.getOptions(t));
              return (this.contextValue = Object(_.a)({}, t.leaflet, { popupContainer: e })), e;
            }),
            (i.updateLeafletElement = function(t, e) {
              e.position !== t.position && this.leafletElement.setLatLng(e.position),
                ...
                e.draggable !== t.draggable &&
                  (!0 === e.draggable ? this.leafletElement.dragging.enable() : this.leafletElement.dragging.disable());
            }),
            (i.render = function() {
              var t = this.props.children;
        ...
        J = (i(174), i(1287)),
        Y = 0,
        X = ['tile', 'shadow', 'overlay', 'map', 'marker', 'tooltip', 'popup'],
        Q = /-*pane/gi,
        ...
        tt = (function(t) {
          function e() {
            ...
            return (
              (e = t.call.apply(t, [this].concat(n)) || this),
              Object(a.a)(Object(r.a)(e), 'state', { name: void 0, context: void 0 }),
              Object(a.a)(Object(r.a)(e), 'setStyle', function(t) {
                var i = void 0 === t ? e.props : t,
                  n = i.style,
                  o = i.className,
                  s = e.getPane(e.state.name);
                s &&
                  (o && Object(T.a)(s, o),
                  n &&
          ...
          return (
            ...
            (i.componentDidUpdate = function(t) {
              if (this.state.name)
                if (this.props.name !== t.name) this.removePane(), this.createPane(this.props);
                else {
                  if (t.className && this.props.className !== t.className) {
                    var e = this.getPane(this.state.name);
                    null != e && null != t.className && Object(T.c)(e, t.className);
                  }
            ...
            (i.createPane = function(t) {
              var e = t.leaflet.map,
                i = t.name || 'pane-' + ++Y;
              if (null != e && null != e.createPane) {
                var n = (function(t) {
                  return -1 !== X.indexOf(t.replace(Q, ''));
                })(i);
                if (null == (n || this.getPane(i))) e.createPane(i, this.getParentPane());
                else;
                this.setState({ name: i, context: Object(_.a)({}, t.leaflet, { pane: i }) }, this.setStyle);
              }
            }),
            (i.removePane = function() {
              var t = this.state.name;
              if (null != t) {
                var e = this.getPane(t);
                null != e && e.remove && e.remove();
                var i = this.props.leaflet.map;
                null != i &&
                  null != i._panes &&
                  ((i._panes = Object(J.a)(i._panes, t)), (i._paneRenderers = Object(J.a)(i._paneRenderers, t)));
              }
            }),
            (i.getParentPane = function() {
              return this.getPane(this.props.pane || this.props.leaflet.pane);
            }),
            (i.getPane = function(t) {
              if (null != t && null != this.props.leaflet.map) return this.props.leaflet.map.getPane(t);
            }),
            (i.render = function() {
              var t = this.state.context;
              return t
                ? l.a.createElement(n.b, { value: t }, l.a.createElement('div', { style: $ }, this.props.children))
                : null;
            }),
            e
          );
        ...
        rt = (function(t) {
          function e() {
            ...
            return (
              (e = t.call.apply(t, [this].concat(n)) || this),
              Object(a.a)(Object(r.a)(e), 'onPopupOpen', function(t) {
                t.popup === e.leafletElement && e.onOpen();
              }),
              Object(a.a)(Object(r.a)(e), 'onPopupClose', function(t) {
                t.popup === e.leafletElement && e.onClose();
              }),
              Object(a.a)(Object(r.a)(e), 'onRender', function() {
                !1 !== e.props.autoPan &&
                  e.leafletElement.isOpen() &&
                  (e.leafletElement._map && e.leafletElement._map._panAnim && (e.leafletElement._map._panAnim = void 0),
          ...
          return (
            (i.getOptions = function(e) {
              return Object(_.a)({}, t.prototype.getOptions.call(this, e), { autoPan: !1 });
            }),
            (i.createLeafletElement = function(t) {
              var e = this.getOptions(t);
              return (e.autoPan = !1 !== t.autoPan), new s.Popup(e, t.leaflet.popupContainer);
            }),
            (i.updateLeafletElement = function(t, e) {
              e.position !== t.position && this.leafletElement.setLatLng(e.position);
            }),
            (i.componentDidMount = function() {
              ...
              null != i && i.on({ popupopen: this.onPopupOpen, popupclose: this.onPopupClose }),
                n ? n.bindPopup(o) : (t && o.setLatLng(t), o.openOn(i));
            }),
            (i.componentWillUnmount = function() {
              var e = this.props.leaflet.map;
              null != e &&
                (e.off({ popupopen: this.onPopupOpen, popupclose: this.onPopupClose }),
      ...
      Object(a.a)(rt, 'defaultProps', { pane: 'popupPane' });
      var at = Object(n.d)(rt),
        ht = (function(t) {
          function e() {
            return t.apply(this, arguments) || this;
          }
        ...
        pt = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(r.a)(i), 'leafletElement', void 0),
              Object(a.a)(Object(r.a)(i), 'container', void 0),
              (i.leafletElement = i.createLeafletElement(e)),
              i
            );
          }
          ...
          return (
            (i.createLeafletElement = function(t) {
              return (
                ...
                new s.SVGOverlay(this.container, t.bounds, this.getOptions(t))
              );
            }),
            (i.updateLeafletElement = function(t, e) {
              e.bounds !== t.bounds && this.leafletElement.setBounds(e.bounds),
                e.opacity !== t.opacity && this.leafletElement.setOpacity(e.opacity),
                e.zIndex !== t.zIndex && this.leafletElement.setZIndex(e.zIndex);
            }),
            (i.componentDidMount = function() {
            ...
            (i.render = function() {
              var t = this.props.children;
              return null == t || null == this.container ? null : Object(E.createPortal)(t, this.container);
            }),
            v(e, [
              {
                key: 'layerContainer',
        ...
        _t = (function(t) {
          ...
          return (
            ...
            (i.updateLeafletElement = function(e, i) {
              t.prototype.updateLeafletElement.call(this, e, i), i.url !== e.url && this.leafletElement.setUrl(i.url);
            }),
            e
          );
        })(B),
        ...
        ft = (function(t) {
          function e() {
            ...
            return (
              (e = t.call.apply(t, [this].concat(n)) || this),
              Object(a.a)(Object(r.a)(e), 'onTooltipOpen', function(t) {
                t.tooltip === e.leafletElement && e.onOpen();
              }),
              Object(a.a)(Object(r.a)(e), 'onTooltipClose', function(t) {
                t.tooltip === e.leafletElement && e.onClose();
              }),
              e
            );
          }
          ...
          return (
            (i.createLeafletElement = function(t) {
              return new s.Tooltip(this.getOptions(t), t.leaflet.popupContainer);
            }),
            (i.componentDidMount = function() {
              var t = this.props.leaflet.popupContainer;
              null != t &&
                (t.on({ tooltipopen: this.onTooltipOpen, tooltipclose: this.onTooltipClose }),
                t.bindTooltip(this.leafletElement));
            }),
            (i.componentWillUnmount = function() {
              var t = this.props.leaflet.popupContainer;
              null != t &&
                (t.off({ tooltipopen: this.onTooltipOpen, tooltipclose: this.onTooltipClose }),
                null != t._map && t.unbindTooltip(this.leafletElement));
            }),
            e
          );
        })(S);
      Object(a.a)(ft, 'defaultProps', { pane: 'tooltipPane' });
      var gt = Object(n.d)(ft),
        vt = (function(t) {
          function e() {
            return t.apply(this, arguments) || this;
          }
          ...
          return (
            ...
            (i.componentDidMount = function() {
              t.prototype.componentDidMount.call(this),
                !0 === this.props.play && this.leafletElement.getElement().play();
            }),
            (i.updateLeafletElement = function(t, e) {
              e.url !== t.url && this.leafletElement.setUrl(e.url),
                e.bounds !== t.bounds && this.leafletElement.setBounds(Object(s.latLngBounds)(e.bounds)),
                ...
                e.zIndex !== t.zIndex && this.leafletElement.setZIndex(e.zIndex),
                !0 !== e.play || t.play
                  ? e.play || !0 !== t.play || this.leafletElement.getElement().pause()
          ...
          return (
            (i.createLeafletElement = function(t) {
              var e = t.url,
                i = Object(d.a)(t, ['url']),
                n = this.getOptions(i),
                o = (n.leaflet, Object(d.a)(n, ['leaflet']));
              return new s.TileLayer.WMS(e, o);
            }),
            (i.updateLeafletElement = function(e, i) {
              t.prototype.updateLeafletElement.call(this, e, i);
              var n = e.url,
                o = (e.opacity, e.zIndex, Object(d.a)(e, ['url', 'opacity', 'zIndex'])),
                s = this.getOptions(o),
                r = (s.leaflet, Object(d.a)(s, ['leaflet'])),
                a = i.url,
                h = (i.opacity, i.zIndex, Object(d.a)(i, ['url', 'opacity', 'zIndex'])),
                l = this.getOptions(h),
                u = (l.leaflet, Object(d.a)(l, ['leaflet']));
              a !== n && this.leafletElement.setUrl(a), f()(u, r) || this.leafletElement.setParams(u);
            }),
            (i.getOptions = function(e) {
              var i = t.prototype.getOptions.call(this, e);
              return Object.keys(i).reduce(function(t, e) {
                return y.a.test(e) || (t[e] = i[e]), t;
              }, {});
            }),
            e
          );
        ...
        wt = Object(n.d)(xt);
      i.d(e, 'LeafletConsumer', function() {
        return n.a;
      }),
        i.d(e, 'LeafletProvider', function() {
          return n.b;
        }),
        i.d(e, 'withLeaflet', function() {
          return n.d;
        }),
        i.d(e, 'useLeaflet', function() {
          return n.c;
        }),
        i.d(e, 'AttributionControl', function() {
          return p;
        }),
        i.d(e, 'Circle', function() {
          return C;
        }),
        i.d(e, 'CircleMarker', function() {
          return O;
        }),
        i.d(e, 'DivOverlay', function() {
          return S;
        }),
        i.d(e, 'FeatureGroup', function() {
          return z;
        }),
        i.d(e, 'GeoJSON', function() {
          return Z;
        }),
        i.d(e, 'GridLayer', function() {
          return B;
        }),
        i.d(e, 'ImageOverlay', function() {
          return I;
        }),
        i.d(e, 'LayerGroup', function() {
          return D;
        }),
        i.d(e, 'LayersControl', function() {
          return F;
        }),
        i.d(e, 'ControlledLayer', function() {
          return R;
        }),
        i.d(e, 'Map', function() {
          return V.a;
        }),
        i.d(e, 'MapComponent', function() {
          return b;
        }),
        i.d(e, 'MapControl', function() {
          return u;
        }),
        i.d(e, 'MapEvented', function() {
          return y.b;
        }),
        i.d(e, 'MapLayer', function() {
          return L;
        }),
        i.d(e, 'Marker', function() {
          return K;
        }),
        i.d(e, 'Pane', function() {
          return et;
        ...
        i.d(e, 'Polygon', function() {
          return nt;
        }),
        i.d(e, 'Polyline', function() {
          return st;
        }),
        ...
        i.d(e, 'ScaleControl', function() {
          return ct;
        }),
        i.d(e, 'SVGOverlay', function() {
          return dt;
        }),
        i.d(e, 'TileLayer', function() {
          return mt;
        }),
        i.d(e, 'Tooltip', function() {
          return gt;
        }),
        i.d(e, 'VideoOverlay', function() {
          return yt;
        }),
        i.d(e, 'WMSTileLayer', function() {
          return Lt;
        }),
        i.d(e, 'ZoomControl', function() {
          return wt;
        });
    },
    1285: function(t, e, i) {
      ...
      t.exports = function t(e, i) {
        ...
        if (e && i && 'object' == typeof e && 'object' == typeof i) {
          ...
          if (Array.isArray(e)) {
            ...
            for (o = n; 0 !== o--; ) if (!t(e[o], i[o])) return !1;
            return !0;
          }
          ...
          if ((n = (s = Object.keys(e)).length) !== Object.keys(i).length) return !1;
          for (o = n; 0 !== o--; ) if (!Object.prototype.hasOwnProperty.call(i, s[o])) return !1;
          for (o = n; 0 !== o--; ) {
            var r = s[o];
    ...
    1286: function(t, e, i) {
      ...
      var n = i(1082),
        ...
        d = i(1192),
        _ = i(1287),
        m = ['children', 'className', 'id', 'style', 'useFlyTo', 'whenReady'],
        f = function(t) {
        ...
        g = (function(t) {
          function e(e) {
            ...
            return (
              (i = t.call(this, e) || this),
              Object(a.a)(Object(s.a)(i), 'className', void 0),
              Object(a.a)(Object(s.a)(i), 'contextValue', void 0),
              Object(a.a)(Object(s.a)(i), 'container', void 0),
              Object(a.a)(Object(s.a)(i), 'viewport', { center: void 0, zoom: void 0 }),
              Object(a.a)(Object(s.a)(i), '_ready', !1),
              Object(a.a)(Object(s.a)(i), '_updating', !1),
              Object(a.a)(Object(s.a)(i), 'onViewportChange', function() {
              ...
              Object(a.a)(Object(s.a)(i), 'onViewportChanged', function() {
                i.props.onViewportChanged && !i._updating && i.props.onViewportChanged(i.viewport);
              }),
              Object(a.a)(Object(s.a)(i), 'bindContainer', function(t) {
                i.container = t;
              }),
          ...
          return (
            ...
            (i.updateLeafletElement = function(t, e) {
              ...
              var i = e.bounds,
                ...
                f = e.viewport,
                g = e.zoom;
              if ((Object(d.b)(this.container, t.className, r), f && f !== t.viewport)) {
              ...
              u && this.shouldUpdateBounds(u, t.maxBounds) && this.leafletElement.setMaxBounds(u),
                ...
                p !== t.tap && (!0 === p ? this.leafletElement.tap.enable() : this.leafletElement.tap.disable()),
                _ !== t.touchZoom &&
                  (!0 === _ || 'string' === typeof _
                    ? ((this.leafletElement.options.touchZoom = _), this.leafletElement.touchZoom.enable())
            ...
            (i.componentDidMount = function() {
              var e = _.a.apply(void 0, [this.props].concat(m));
            ...
            (i.shouldUpdateCenter = function(t, e) {
              return !e || ((t = f(t)), (e = f(e)), t[0] !== e[0] || t[1] !== e[1]);
            }),
            ...
            (i.render = function() {
              return u.a.createElement(
                ...
                this.contextValue ? u.a.createElement(c.b, { value: this.contextValue }, this.props.children) : null
              );
            }),
            e
          );
        ...
        void 0 ===
          (s =
            ...
            typeof (n = function(t) {
              'use strict';
              return (
                (t.TileLayer.Provider = t.TileLayer.extend({
                  initialize: function(e, i) {
                    var n = t.TileLayer.Provider.providers,
                      o = e.split('.'),
                      s = o[0],
                      r = o[1];
                    if (!n[s]) throw 'No such provider (' + s + ')';
                    var a = { url: n[s].url, options: n[s].options };
                    if (r && 'variants' in n[s]) {
                      if (!(r in n[s].variants)) throw 'No such variant of ' + s + ' (' + r + ')';
                      var h,
                        l = n[s].variants[r];
                      (h = 'string' === typeof l ? { variant: l } : l.options),
                        (a = { url: l.url || a.url, options: t.Util.extend({}, a.options, h) });
                    }
                    a.options.attribution = (function t(e) {
                      return -1 === e.indexOf('{attribution.')
                        ? e
                        : e.replace(/\{attribution.(\w*)\}/g, function(e, i) {
                            return t(n[i].options.attribution);
                          });
                    })(a.options.attribution);
                    var u = t.Util.extend({}, a.options, i);
                    t.TileLayer.prototype.initialize.call(this, a.url, u);
                  }
                })),
                (t.TileLayer.Provider.providers = {
                  OpenStreetMap: {
                    ...
                    variants: {
                      ...
                      CH: {
                        ...
                        options: { maxZoom: 18, bounds: [[45, 5], [48, 11]] }
                      },
                      France: {
                      ...
                      HOT: {
                        ...
                        options: {
                          attribution:
                            '{attribution.OpenStreetMap}, Tiles style by <a href="https://www.hotosm.org/" target="_blank">Humanitarian OpenStreetMap Team</a> hosted by <a href="https://openstreetmap.fr/" target="_blank">OpenStreetMap France</a>'
                        }
                      },
                      BZH: {
                  ...
                  Hydda: {
                    ...
                    variants: { Full: 'full', Base: 'base', RoadsAndLabels: 'roads_and_labels' }
                  },
                  MapBox: {
                    url: 'https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}{r}.png?access_token={accessToken}',
                    options: {
                      attribution:
                        '<a href="https://www.mapbox.com/about/maps/" target="_blank">&copy; Mapbox</a> {attribution.OpenStreetMap} <a href="https://www.mapbox.com/map-feedback/" target="_blank">Improve this map</a>',
                      subdomains: 'abcd',
                      id: 'mapbox.streets',
                  ...
                  Stamen: {
                    ...
                    variants: {
                      ...
                      Watercolor: {
                        ...
                        options: { variant: 'watercolor', ext: 'jpg', minZoom: 1, maxZoom: 16 }
                      },
                      Terrain: { options: { variant: 'terrain', minZoom: 0, maxZoom: 18 } },
                      TerrainBackground: { options: { variant: 'terrain-background', minZoom: 0, maxZoom: 18 } },
                      TerrainLabels: { options: { variant: 'terrain-labels', minZoom: 0, maxZoom: 18 } },
                      TopOSMRelief: {
                        url: 'https://stamen-tiles-{s}.a.ssl.fastly.net/{variant}/{z}/{x}/{y}.{ext}',
                        options: { variant: 'toposm-color-relief', ext: 'jpg', bounds: [[22, -132], [51, -56]] }
                      },
                      TopOSMFeatures: {
                        options: { variant: 'toposm-features', bounds: [[22, -132], [51, -56]], opacity: 0.9 }
                      }
                    }
                  },
                  TomTom: {
                    ...
                    variants: { Basic: 'basic', Hybrid: 'hybrid', Labels: 'labels' }
                  },
                  Esri: {
                    ...
                    variants: {
                      WorldStreetMap: {
                        options: {
                          attribution:
                            '{attribution.Esri} &mdash; Source: Esri, DeLorme, NAVTEQ, USGS, Intermap, iPC, NRCAN, Esri Japan, METI, Esri China (Hong Kong), Esri (Thailand), TomTom, 2012'
                        }
                      },
                      DeLorme: {
                        options: {
                  ...
                  HERE: {
                    ...
                    variants: {
                      ...
                      normalDayTraffic: {
                        options: { variant: 'normal.traffic.day', base: 'traffic', type: 'traffictile' }
                      },
                      ...
                      mapLabels: { options: { type: 'labeltile', format: 'png' } },
                      trafficFlow: { options: { base: 'traffic', type: 'flowtile' } },
                      carnavDayGrey: 'carnav.day.grey',
                      hybridDay: { options: { base: 'aerial', variant: 'hybrid.day' } },
                      hybridDayMobile: { options: { base: 'aerial', variant: 'hybrid.day.mobile' } },
                      hybridDayTransit: { options: { base: 'aerial', variant: 'hybrid.day.transit' } },
                      hybridDayGrey: { options: { base: 'aerial', variant: 'hybrid.grey.day' } },
                      hybridDayTraffic: {
                        options: { variant: 'hybrid.traffic.day', base: 'traffic', type: 'traffictile' }
                      },
                      pedestrianDay: 'pedestrian.day',
                      pedestrianNight: 'pedestrian.night',
                      satelliteDay: { options: { base: 'aerial', variant: 'satellite.day' } },
                      terrainDay: { options: { base: 'aerial', variant: 'terrain.day' } },
                      terrainDayMobile: { options: { base: 'aerial', variant: 'terrain.day.mobile' } }
                    }
                  },
                  FreeMapSK: {
                  ...
                  HikeBike: {
                    ...
                    options: { maxZoom: 19, attribution: '{attribution.OpenStreetMap}', variant: 'hikebike' },
                    variants: { HikeBike: {}, HillShading: { options: { maxZoom: 15, variant: 'hillshading' } } }
                  },
                  BasemapAT: {
                    ...
                    variants: {
                      basemap: { options: { maxZoom: 20, variant: 'geolandbasemap' } },
                      grau: 'bmapgrau',
                      overlay: 'bmapoverlay',
                      terrain: { options: { variant: 'bmapgelaende', type: 'grau', format: 'jpeg' } },
                      surface: { options: { variant: 'bmapoberflaeche', type: 'grau', format: 'jpeg' } },
                      highdpi: { options: { variant: 'bmaphidpi', format: 'jpeg' } },
                      orthofoto: { options: { maxZoom: 20, variant: 'bmaporthofoto30cm', format: 'jpeg' } }
                    }
                  },
                  nlmaps: {
                    url:
                  ...
                  NASAGIBS: {
                    ...
                    variants: {
                      ...
                      ViirsEarthAtNight2012: { options: { variant: 'VIIRS_CityLights_2012', maxZoom: 8 } },
                      ModisTerraLSTDay: {
                        options: {
                      ...
                      ModisTerraSnowCover: {
                        options: { variant: 'MODIS_Terra_Snow_Cover', format: 'png', maxZoom: 8, opacity: 0.75 }
                      },
                      ModisTerraAOD: {
                        options: { variant: 'MODIS_Terra_Aerosol', format: 'png', maxZoom: 6, opacity: 0.75 }
                      },
                  ...
                  GeoportailFrance: {
                    ...
                    variants: {
                      ...
                      orthos: { options: { maxZoom: 19, variant: 'ORTHOIMAGERY.ORTHOPHOTOS' } }
                    }
                  },
                  OneMapSG: {
                ...
                (t.tileLayer.provider = function(e, i) {
                  return new t.TileLayer.Provider(e, i);
                }),
                t
              );
            })
    ...
    2156: function(t, e, i) {
      ...
      var n,
        ...
        a = i(1193),
        h = i(1076);
      var l = h.Control.extend({
        options: { className: '', onOff: '', handleOff: function() {} },
        onAdd: function() {
          var t = h.DomUtil.create('div', this.options.className);
          return h.DomEvent.disableClickPropagation(t), t;
        },
        onRemove: function(t) {
          return this.options.onOff && t.off(this.options.onOff, this.options.handleOff, this), this;
        }
      });
      e.default = (0, a.withLeaflet)(
        (function(t) {
          function e() {
            return (
              (function(t, e) {
            ...
            o(e, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  })(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'componentDidMount', this).call(this),
                    this.forceUpdate();
                }
              },
              {
                key: 'render',
                value: function() {
                  return this.leafletElement && this.leafletElement.getContainer()
                    ? r.default.createPortal(this.props.children, this.leafletElement.getContainer())
                    : null;
                }
              }
            ]),
                  ...
                  for (
                    ...
                    if ((i = t[l]) instanceof L.LayerGroup)
                      ...
                      if (
                        ...
                        var _ = i.__parent.getAllChildMarkers(),
                          m = _[0] === i ? _[1] : _[0];
                        n.removeLayer(m);
                      }
                  ...
                  for (i = l - 1; l + 1 >= i; i++)
                    if ((s = o[i]))
                      for (n = 0, r = s.length; r > n; n++)
                        (a = s[n]),
                          (p > (h = this._sqDist(c[L.Util.stamp(a)], t)) || (p >= h && null === d)) &&
                            ((p = h), (d = a));
              return d;
            },
          ...
          (L.QuickHull = {
            ...
            getConvexHull: function(t) {
              ...
              for (e = t.length - 1; e >= 0; e--) {
                var p = t[e];
                (!1 === i || p.lat > i) && ((r = p), (i = p.lat)),
                  (!1 === n || p.lat < n) && ((a = p), (n = p.lat)),
                  (!1 === o || p.lng > o) && ((h = p), (o = p.lng)),
                  (!1 === s || p.lng < s) && ((l = p), (s = p.lng));
              }
              return (
                n !== i ? ((c = a), (u = r)) : ((c = l), (u = h)),
          ...
          L.MarkerCluster.include({
            _animationSpiderfy: function(t, e) {
              ...
              for (l._forceLayout(), l._animationStart(), i = t.length - 1; i >= 0; i--)
                (a = u.layerPointToLatLng(e[i])),
                  ...
                  _ && (((s = (o = n._spiderLeg)._path).style.strokeDashoffset = 0), o.setStyle({ opacity: f }));
              this.setOpacity(0.3),
                (l._ignoreMove = !1),
                setTimeout(function() {
            ...
            _animationUnspiderfy: function(t) {
              var e,
                ...
                d = L.Path.SVG;
              for (h._ignoreMove = !0, h._animationStart(), this.setOpacity(1), i = p.length - 1; i >= 0; i--)
                (e = p[i])._preSpiderfyLatlng &&
                  (e.closePopup(),
              ...
              (h._ignoreMove = !1),
                setTimeout(function() {
                  var t = 0;
                  for (i = p.length - 1; i >= 0; i--) (e = p[i])._spiderLeg && t++;
                  for (i = p.length - 1; i >= 0; i--)
                    (e = p[i])._spiderLeg &&
                      ...
                      delete e._spiderLeg);
                  h._animationEnd(), h.fire('unspiderfied', { cluster: a, markers: p });
                }, 200);
            }
          }),
          L.MarkerClusterGroup.include({
...
//# sourceMappingURL=8.96177e83.chunk.js.map
